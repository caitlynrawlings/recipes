  ...
  const DropdownPreview: React.FC = () => {
      return (
          <div 
              ...
              className="sort-dropdown-preview flex flex-row h-10 cursor-pointer mt-1.5 bg-zinc-100 text-zinc-600 text-ellipsis text-md rounded-md p-1.5 items-center gap-2"
          >   
              <div className='overflow-hidden text-ellipsis whitespace-nowrap w-52 mr-0'>
                {selectedOption}
              </div>
  ...
  const SelectOptionsBox: React.FC = () => {
    return (
        <div className='sort-dropdown z-20 '>
            {isOpen && (
                <div className="bg-zinc-100 fixed text-md shadow-lg py-2 rounded-md dropdown flex flex-col w-60">
